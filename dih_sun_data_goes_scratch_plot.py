...
#
#
#Name: dih_sun_goes_scratch_plot
#
...
#
#
def dih_sun_goes_scratch_plot(datalist,start_time,savename):
	...
	plt.savefig('/Volumes/Scratch/Users/dherman/sundata/sun_plots/' + start_time2 + '_' + savename + '_GOEScurve.ps')#saves postscript file
	return [metadatalist,x,ysmooth]
#
#
#
#Name: dih_sun_recurs_goes_scratch_plot
#
...
def dih_sun_recurs_goes_scratch_plot(file_131,savename):
	...
	for member in meta_lines:
		...
		try:
			...
			print 'ValueError when attempting evaluate metadata'
			continue
		...
		columns = dih_run_idl_goes_script(start_string,end_string,'/Volumes/Scratch/Users/dherman/sundata/metadata/' + savename + '_goes_curve_' + member[0] + '.txt')
		if columns == 11:
			continue
		with open('/Volumes/Scratch/Users/dherman/sundata/metadata/' + savename + '_goes_curve_' + member[0] + '.txt','r') as f:
			first_line = [f.readline()]
			real_first_time = dih_create_goes_times(first_line)[0]
		list_goes = dih_sun_goes_scratch_plot(columns,real_first_time,savename)
		if list_goes == 11:
			continue
		metadatalist = list_goes[0]
		meta_file = open('/Volumes/Scratch/Users/dherman/sundata/metadata/' + savename + '_all_human_meta_131_goes.txt','a')
